...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_2f5c4e4c_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(142);
      var disposed = false
      ...
      var Component = normalizeComponent(
        ...
        __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_2f5c4e4c_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
        __vue_styles__,
        __vue_scopeId__,
        __vue_module_identifier__
      )
      Component.options.__file = "src\\pages\\change_team_info\\index.vue"
      ...
      if (false) {
        (function () {
          ...
          module.hot.accept()
          if (!module.hot.data) {
            hotAPI.createRecord("data-v-2f5c4e4c", Component.options)
          } else {
            hotAPI.reload("data-v-2f5c4e4c", Component.options)
          }
...
/* harmony default export */ __webpack_exports__["a"] = ({
        ...
        methods: {
          ...
          fetchShowData: function fetchShowData(TeamID) {
            this.show.id = TeamID;
            var token = wx.getStorageSync('token');
            var that = this;
            wx.request({
              url: 'http://120.78.1.231:8084/api/team?team_id=' + parseInt(TeamID, 10),
              method: 'GET',
              header: {
                'token': '' + token
              },
          ...
          AgreeAudit: function AgreeAudit() {
            ...
            var that = this;
            wx.request({
              url: 'http://120.78.1.231:8084/api/team/modify',
              method: 'POST',
              data: {
                team_number: parseInt(this.show.id, 10),
                team_name: this.show.name,
                introduction: this.show.intro,
                academy: this.data.areaText,
                teacher: parseInt(this.data.selectedId), // 要改成修改的老师ID，
...
/* harmony default export */ __webpack_exports__["a"] = (esExports);
      if (false) {
        module.hot.accept()
        if (module.hot.data) {
          require("vue-hot-reload-api").rerender("data-v-2f5c4e4c", esExports)
        }
      }
